...
class BeaconScanner: NSObject, CBCentralManagerDelegate {
    ...
    private let beaconOperationsQueue: DispatchQueue = DispatchQueue.
        //DispatchQueue("beacon_operations_queue", nil)
        ...
        if let serviceData = advertisementData[CBAdvertisementDataServiceDataKey]
            ...
            if eft == BeaconInfo.EddystoneFrameType.TelemetryFrameType {
                ...
                if let
                    ...
                    //       each time.
                    self.deviceIDCache.removeValue(forKey: peripheral.identifier as NSUUID)
