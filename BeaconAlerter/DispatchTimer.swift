...
class DispatchTimer: NSObject {
    ...
    private let queue: DispathSource
    ...
    class func scheduledDispatchTimer(delay: TimeInterval,
    ...
    func reschedule() {
        let start = DispatchTime.now(dispatch_time_t(DISPATCH_TIME_NOW), Int64(self.delay * Double(NSEC_PER_SEC)))
